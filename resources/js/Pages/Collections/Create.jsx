...
export default function Create({auth}) {
    ...
    const handleStoreData = async (e) => {
        ...
        // notif jika data berhasil dikirim
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Create Collections</h2>}
        >
            <Head title={'Create Collections'}/>
            <Container>
                <Card title={'Create new collections'}>
